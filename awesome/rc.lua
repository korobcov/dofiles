...
run_once("xxkb")
-- run_once("slimlock")
run_once("sleep 15 && qtnote")
run_once("mocp -S")
--samsung 
run_once("/usr/bin/python2 /usr/share/samsung-tools/session-service.py")
run_once("/usr/bin/python2 /usr/share/samsung-tools/system-service.py")
-- }}}
...
--	names = {"⠐", "⠡", "⠪", "⠵", "⠻", "⠿", "7", "8", "9"},
 ...
 layout = { layouts[2], layouts[3], layouts[2], layouts[2], layouts[4], layouts[1], 
...
awful.tag.setproperty(tags[1][1], "mwfact", 0.15)
awful.tag.setncol(2, tags[1][1])

awful.tag.setproperty(tags[1][8], "mwfact", 0.15)
awful.tag.setncol(2, tags[1][8])
...
globalkeys = awful.util.table.join(
    ...
    -- Widgets popups
    awful.key({ altkey,           }, "c",      function () lain.widgets.calendar:show(3) end),
...
awful.key({  }, "XF86MonBrightnessUp",
    ...
    awful.key({ altkey }, "Tab", function () awful.util.spawn(win) end),
...
{ rule = { class = "Psi-plus" }, except = { instance = "main" },
          callback = awful.client.setslave },
{ rule_any = { name = { "Psi+: Настройки", "Psi+: Options" } },
  	  properties = { width = 750, height = 400 } },
{ rule = { class = "Psi" },
          properties = { tag = tags[1][1], switchtotag = true } },
{ rule = { class = "Psi" }, except = { instance = "main" },
          callback = awful.client.setslave },
{ rule_any = { name = { "Psi: Настройки", "Psi: Options" } },
          properties = { width = 750, height = 400 } },
...
{ rule = { class = "Skype" }, except = { instance = "ConversationsWindow" },
          callback = awful.client.setslave },
